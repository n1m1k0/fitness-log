...
from fitness_log.cli import main
from fitness_log.models import Note, ProjectState, Task
from fitness_log.cli import demo_state
from fitness_log.storage import load_state, save_state
from fitness_log.models import generate_short_id
from fitness_log.validation import normalize_tags, require_text, validate_task_status
from fitness_log.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
